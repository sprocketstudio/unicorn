(function(_, D) {
    ...
    const me = `
        precision mediump float;`.replace(/\n/g, ""), Oe = `
        attribute vec3 aVertexPosition;
    attribute vec2 aTextureCoord;`.replace(/\n/g, ""), _e = `
        varying vec3 vVertexPosition;
    varying vec2 vTextureCoord;`.replace(/\n/g, ""), ht = (me + Oe + _e + `
    ...
    class Ve {
        ...
        createShader(e, t) {
            ...
            if (this.gl.shaderSource(s, e), this.gl.compileShader(s), !this.renderer.production && !this.gl.getShaderParameter(s, this.gl.COMPILE_STATUS)) {
                ...
                return a = a.join(``), g(this.type + ": Errors occurred while compiling the", i, `: `, this.gl.getShaderInfoLog(s)), F(a), g(this.type + ": Will use a default", i), this.createShader(t === this.gl.VERTEX_SHADER ? this.defaultVsCode : this.defaultFsCode, t)
            }
            return s
        }
        useNewShaders() {
    ...
    class Z {
        ...
        getInverse() {
            const e = this.elements, t = new Z, s = t.elements;
            let i = e[0], r = e[1], a = e[2], h = e[3], o = e[4], l = e[5], d = e[6], u = e[7], c = e[8], f = e[9], p = e[10], m = e[11], v = e[12], T = e[13], S = e[14], E = e[15], M = i * l - r * o, k = i * d - a * o, C = i * u - h * o, y = r * d - a * l, O = r * u - h * l, Y = a * u - h * d, U = c * T - f * v, V = c * S - p * v, q = c * E - m * v, P = f * S - p * T, w = f * E - m * T, R = p * E - m * S, x = M * R - k * w + C * P + y * q - O * V + Y * U;
        ...
        compose(e, t, s) {
            let i = this.elements;
            const r = t.elements[0], a = t.elements[1], h = t.elements[2], o = t.elements[3], l = r + r, d = a + a, u = h + h, c = r * l, f = r * d, p = r * u, m = a * d, v = a * u, T = h * u, S = o * l, E = o * d, M = o * u, k = s.x, C = s.y, y = s.z;
        ...
        composeFromOrigin(e, t, s, i) {
            let r = this.elements;
            const a = t.elements[0], h = t.elements[1], o = t.elements[2], l = t.elements[3], d = a + a, u = h + h, c = o + o, f = a * d, p = a * u, m = a * c, v = h * u, T = h * c, S = o * c, E = l * d, M = l * u, k = l * c, C = s.x, y = s.y, O = s.z, Y = i.x, U = i.y, V = i.z, q = (1 - (v + S)) * C, P = (p + k) * C, w = (m - M) * C, R = (p - k) * y, x = (1 - (f + S)) * y, z = (T + E) * y, $ = (m + M) * O, ie = (T - E) * O, B = (1 - (f + v)) * O;
    ...
    class b {
        ...
        applyQuat(e) {
            const t = this._x, s = this._y, i = this._z, r = e.elements[0], a = e.elements[1], h = e.elements[2], o = e.elements[3], l = o * t + a * i - h * s, d = o * s + h * t - r * i, u = o * i + r * s - a * t, c = -r * t - a * s - h * i;
    ...
    const Ee = new A, ut = new b, ft = new Z;
    class ae {
        constructor(e, {
            isFBOTexture: t = !1,
            fromTexture: s = !1,
        ...
        _getSizes() {
            ...
            const e = this._parent.scale ? Ee.set(this._parent.scale.x, this._parent.scale.y) : Ee.set(1, 1), t = this._parent._boundingRect.document.width * e.x, s = this._parent._boundingRect.document.height * e.y, i = this._size.width, r = this._size.height, a = i / r, h = t / s;
            let o = 0, l = 0;
    ...
    class Be {
        ...
        loadImage(e, t = {}, s, i) {
            ...
            const o = new ae(this.renderer, a), l = this._addElement(h, o, s, i);
            h.complete ? this._sourceLoaded(h, o, s) : h.decode ? h.decode().then(this._sourceLoaded.bind(this, h, o, s)).
            catch (() = > {
        ...
        loadVideo(e, t = {}, s, i) {
            ...
            const h = new ae(this.renderer, a), o = this._addElement(r, h, s, i);
    ...
    class gt {
        ...
        loadImage(e, t = {}, s, i) {
            this.loader.loadImage(e, Object.assign(t, this._texturesOptions), r = > {
                ...
                this.renderer.production || g(this.type + `: There has been an error: `, a, `
                    while loading this image: `, r), i && i(r, a)
            })
        }
        loadVideo(e, t = {}, s, i) {
            this.loader.loadVideo(e, Object.assign(t, this._texturesOptions), r = > {
                ...
                this.renderer.production || g(this.type + `: There has been an error: `, a, `
                    while loading this video: `, r), i && i(r, a)
            })
        }
        loadCanvas(e, t = {}, s) {
    ...
    class _t extends gt {
        ...
        mouseToPlaneCoords(e) {
            const t = this.scale ? this.scale : mt.set(1, 1), s = We.set((this._boundingRect.document.width - this._boundingRect.document.width * t.x) / 2, (this._boundingRect.document.height - this._boundingRect.document.height * t.y) / 2), i = {
    ...
    class xt {
        ...
        updateProjectionMatrix() {
            const e = this.width / this.height, t = this.near * Math.tan(Math.PI / 180 * .5 * this.fov), s = 2 * t, i = e * s, r = -.5 * i, a = r + i, h = t - s, o = 2 * this.near / (a - r), l = 2 * this.near / (t - h), d = (a + r) / (a - r), u = (t + h) / (t - h), c = -(this.far + this.near) / (this.far - this.near), f = -2 * this.far * this.near / (this.far - this.near);
    ...
    class xe {
        ...
        setFromVec3(e) {
            const t = e.x * .5, s = e.y * .5, i = e.z * .5, r = Math.cos(t), a = Math.cos(s), h = Math.cos(i), o = Math.sin(t), l = Math.sin(s), d = Math.sin(i);
    ...
    const yt = new A, bt = new b, Pt = new b, wt = new b, vt = new b, Tt = new b, Rt = new b, N = new b, H = new b, Ne = new xe, St = new b(.5, .5, 0), Et = new b, Mt = new b, Ct = new b, At = new b, kt = new A;
    class He extends _t {
        constructor(e, t, {
            widthSegments: s,
            heightSegments: i,
        ...
        mouseToPlaneCoords(e) {
            if (Ne.setAxisOrder(this.quaternion.axisOrder), Ne.equals(this.quaternion) && St.equals(this.transformOrigin)) return super.mouseToPlaneCoords(e); {
                ...
                }, s = this.camera.position.clone(), i = Et.set(t.x, t.y, -.5);
                i.unproject(this.camera), i.sub(s).normalize();
                const r = Mt.set(0, 0, -1);
                r.applyQuat(this.quaternion).normalize();
                const a = At.set(0, 0, 0), h = r.dot(i);
                if (Math.abs(h) >= 1e-4) {
                    const o = this._matrices.world.matrix.getInverse().multiply(this.camera.viewMatrix), l = this._boundingRect.world.transformOrigin.clone().add(this._translation), d = Ct.set(this._translation.x - l.x, this._translation.y - l.y, this._translation.z - l.z);
    ...
    let ye, de, Ce = !1, re = window.innerHeight || document.documentElement.clientHeight, J = window.innerWidth || document.documentElement.clientWidth, G = window.scrollY || window.pageYOffset, Ae = 0, ne = 0, ce = 0, ue, be = null, he;
    ...
    function ke(n, e, t, s, i) {
        if (t.length > 1) {
            let r = s ? +s * 2 * Math.PI : 0, a = e.width / 2, h = e.height / 2, o = e.width / 2, l = e.height / 2, d;
            if (i === "radial") {
                const f = Math.max(o, l);
                d = n.createRadialGradient(a, h, f, a, h, 0)
            }
            const u = Math.cos(r) * o, c = Math.sin(r) * l;
    ...
    function oe(n) {
        ...
        const e = n.hasOwnProperty("trackMouse") && n.trackMouse !== 0 || n.hasOwnProperty("axisTilt") && n.axisTilt !== 0 || n.hasOwnProperty("trackMouseMove") && n.trackMouseMove !== 0, t = n.states && [...n.states.appear, ...n.states.scroll, ...n.states.hover].length > 0, s = n.layerType === "effect" && (n.animating || n.usesPingPong), i = n.type === "video", r = e || t || s || i;
    ...
    function je(n, e) {
        ...
        break: break -word;
        transform: rotateZ($ {
                Math.round(n.rotation * 360)
            }
            deg);
        color: transparent;
        z - index: 2;`, u.innerText = n.textContent, d || e.appendChild(u)
    }

    function Dt(n) {
        const e = n.split(",").map(r = > r.trim()), t = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), s = /iPad|iPhone|iPod/.test(navigator.userAgent);
        if (t || s) {
    ...
    class Ut {
        ...
        updateEffect(e, t) {
            ...
            const s = performance.now(), i = Ge(this.transition.ease), r = (this.startTime || t) + this.transition.delay, a = s - r;
            if (a < 0) return !1;
            if (this.loop !== "none") {
                const o = this.transition.duration + this.loopDelay, l = a % o;
                if (l > this.transition.duration) return !1;
                const d = l / this.transition.duration, u = Math.floor(a / o);
                let c = d;
    ...
    class Vt {
        ...
        updateEffect(e, {
            ...
            if (i && (t -= G), this.mode === "scrollIntoView") {
                const r = t + G - re * this.offset, a = r + (re + s) * this.range;
                let h = (G - r) / (a - r), o = Math.max(0, Math.min(1, h));
    ...
    class Bt {
        ...
        updateEffect(e, t, s) {
            var c;
            if (e === void 0) return !1;
            const i = (c = s == null ? void 0 : s.getParent) == null ? void 0 : c.call(s), r = performance.now();
            if (this.triggerOnElement && (s != null && s.isElement || i)) {
                let f = (i || s).isHovered();
                f && !this.lastEnterTime ? t = r : f ? t = this.lastEnterTime : t = null
            }
            const a = t === null, h = a ? this.lastTick || r : t + this.transition.delay, o = (r - h) / this.transition.duration, l = Math.max(0, Math.min(1, o));
            ...
            const d = Ge(this.transition.ease)(this.rawProgress), u = Math.abs(this.progress - d) > 1e-7;
    ...
    class Ye {
        ...
        setBreakpointValues() {
            const e = J, t = this.breakpoints.sort((r, a) = > a.min - r.min), s = {};
    ...
    let Ie = class extends Ye {
        ...
        createLocalCanvas() {
            const t = this.state(), s = document.createElement("canvas"), i = this.getPixelRatio();
        ...
        box() {
            const t = le(this.anchorPoint), {
                ...
                left: r,
                top: a
            } = this.getAbsolutePosition(), h = s * (.5 - t.x), o = i * (.5 - t.y);
            return {
                anchor: {
                    x: r + h,
                    y: a + o
        ...
        getAbsolutePosition() {
            var l, d, u, c;
            const t = this.state(), s = t.canvasWidth, i = t.canvasHeight;
            let r = ((d = (l = this.local) == null ? void 0 : l.stateEffectProps) == null ? void 0 : d.left) ? ? this.left, a = ((c = (u = this.local) == null ? void 0 : u.stateEffectProps) == null ? void 0 : c.top) ? ? this.top;
            const h = this.leftMode === "fixed" ? Math.round(r) : Math.round(r * s), o = this.topMode === "fixed" ? Math.round(a) : Math.round(a * i);
            return {
                left: h,
                top: o
            }
        ...
        getAbsoluteDimensions() {
            ...
            const t = this.state();
            let s, i;
            const r = t.canvasWidth, a = t.canvasHeight;
            let h = ((d = (l = this.local) == null ? void 0 : l.stateEffectProps) == null ? void 0 : d.width) ? ? this.width, o = ((c = (u = this.local) == null ? void 0 : u.stateEffectProps) == null ? void 0 : c.height) ? ? this.height;
    ...
    class Nt extends Ie {
        ...
        render() {
            ...
            let l = ((p = this.local.stateEffectProps) == null ? void 0 : p.borderRadius) ? ? this.borderRadius, d = ((m = this.local.stateEffectProps) == null ? void 0 : m.strokeWidth) ? ? this.strokeWidth, u = ((v = this.local.stateEffectProps) == null ? void 0 : v.gradientAngle) ? ? this.gradientAngle, c = i - o.x * a, f = r - o.y * h;
        ...
        drawPolygon(t, s, i, r) {
            t.beginPath();
            for (let a = 0; a < r; a++) {
                const h = a * 2 * Math.PI / r - Math.PI / 2, o = s * Math.cos(h), l = i * Math.sin(h);
    ...
    class Gt extends Ie {
        ...
        renderImage() {
            ...
            if (this.fitToCanvas) {
                ...
                const p = (o - a) / 2, m = (l - h) / 2;
                t.drawImage(this.local.img, p, m, a, h)
            } else {
                const c = le(this.anchorPoint), f = (((u = this.local.stateEffectProps) == null ? void 0 : u.rotation) ? ? this.rotation) * 2 * Math.PI;
                let p = c.x * a, m = c.y * h;
                t.save();
                let v = a / 2, T = h / 2, S = i - p + v, E = r - m + T;
    ...
    class jt extends Ie {
        ...
        loadFont() {
            var o;
            const t = this.fontStyle.includes("italic") ? "italic" : "normal", s = l = > l === "normal" || l === "400" || l === 400 ? "normal" : l.toString(), i = isNaN(parseInt(this.fontWeight)) ? "normal" : s(this.fontWeight);
            ...
            const h = new FontFace(this.fontFamily, `url($ {
                a
            })`, {
                style: t,
                weight: i
        ...
        render() {
            ...
            const a = le(this.anchorPoint), h = ((q = (V = this.local) == null ? void 0 : V.stateEffectProps) == null ? void 0 : q.rotation) || this.rotation;
            let o = this.state(), l = this.height, d = s - a.x * r, u = i - a.y * l, c = 0, {
                fontSize: f,
                lineHeight: p,
                letterSpacing: m
            } = this.getAbsoluteFontValues(o), v = this.fontStyle.includes("italic") ? "italic" : "normal", T = /^\d+$/.test(this.fontStyle) ? this.fontStyle : "400";
            t.clearRect(0, 0, o.canvasWidth, o.canvasHeight), t.font = `$ {
                v
            }
            $ {
                T
            ...
            px $ {
                this.fontFamily
            }, -apple - system, BlinkMacSystemFont, Helvetica, Arial`, this.isSafari || (t.textAlign = this.textAlign, t.letterSpacing = m + "px");
            ...
            const k = (P, w, R, x, z, $, ie) = > {
                let B = w.split("").reduce((I, K, ss) = > I + P.measureText(K).width + (ss < w.length - 1 ? z : 0), 0), W;
            ...
            for (let P = 0; P < O; P++) {
                ...
                for (let x = 0; x < R.length; x++) {
                    ...
                    if ((this.isSafari && m ? Y(t, $, m) : t.measureText($).width) > r || z === ``) {
                        if (w !== "") y[P] = w.trim(), x !== R.length - 1 ? (y.splice(P + 1, 0, R.slice(x).join("")), O++) : z !== `` && y.push(z);
                        else {
                            let B = z, W = P;
                            for (; B.length > 0;) {
                                let I = "";
    ...
    function qe(n, e, t = 50) {
        const s = e || n.getBoundingClientRect(), i = s.top >= -t && s.top <= re + t || s.bottom >= -t && s.bottom <= re + t || s.top <= 0 && s.bottom >= re, r = s.left >= -t && s.left <= J + t || s.right >= -t && s.right <= J + t || s.left <= 0 && s.right >= J;
        return i && r
    }
    ...
    function Qe(n) {
        const e = _.scenes.filter(i = > i.getDynamicLayers().length), t = _.scenes.filter(i = > i.rendering);
    ...
    function Yt() {
        _.scenes.forEach(n = > {
            ...
            if (n.isInView && ((t = (e = n.curtain) == null ? void 0 : e.planes) != null && t.find(h = > h.uniforms.mousePos)) && !(we() && ((i = (s = n.interactivity) == null ? void 0 : s.mouse) != null && i.disableMobile) || (a = (r = n.interactivity) == null ? void 0 : r.mouse) != null && a.disabled)) {
                ...
                let h = n.isFixed ? n.bbox.top : n.bbox.top + n.scrollY, o = n.bbox.left;
    ...
    function Re(n) {
        _.scenes.filter(e = > e.isInView && e.initialized).forEach(e = > {
            ...
            const a = i - t.left, h = r - (t.top + (e.isFixed ? 0 : G));
    ...
    class $t {
        ...
        preloadTextures() {
            this.layers.forEach(e = > {
                ...
                if (e.isElement) e.local.canvas ? this.textureLoader.loadCanvas(e.local.canvas, {
                    ...
                    const u = ((r = e == null ? void 0 : e.texture) == null ? void 0 : r.src) || ((h = (a = e == null ? void 0 : e.data) == null ? void 0 : a.texture) == null ? void 0 : h.src), c = ((o = e == null ? void 0 : e.texture) == null ? void 0 : o.sampler) || ((d = (l = e == null ? void 0 : e.data) == null ? void 0 : l.texture) == null ? void 0 : d.sampler) || "uTexture";
        ...
        getSplitOrderedItems() {
            ...
            if (s) {
                let i = s.parentLayer ? s.getParent() : null, r = i && oe(i), a = i && i.effects && i.effects.length && i.getChildEffectItems().filter(h = > oe(h)).length;
        ...
        createPlane(e, t, s) {
            ...
            try {
                ...
                let h = (s == null ? void 0 : s.downSample) || (s == null ? void 0 : s.index) === 0 && ((a = e.data) == null ? void 0 : a.downSample), o = this.renderingScale;
        ...
        createPingPongPlane(e, t, s) {
            var a;
            let i = this.getPlaneParams(e, 1 + ((s == null ? void 0 : s.length) || 0)), r = (a = this.curtain) == null ? void 0 : a.planes.find(h = > h.type === "PingPongPlane" && h.userData.id === e.local.id);
        ...
        handleEffectPlane(e, t, s) {
            ...
            if (!i) return !1;
            let r = this.getRenderTargets()[t - 1], a = (o = this.curtain) == null ? void 0 : o.planes.find(l = > l.type === "PingPongPlane" && l.userData.id === e.local.id), h = e.compiledFragmentShaders[s.passIndex ? ? 0];
        ...
        handleElementPlane(e, t) {
            const s = e.getPlane();
            if (!s) return !1;
            const i = e.getChildEffectItems(), r = this.layers.filter(l = > !l.parentLayer);
            let a = this.getRenderTargets()[t - 1], h = r[r.indexOf(e) - 2], o;
        ...
        handleChildEffectPlane(e, t, s) {
            ...
            if (!i) return;
            const r = e.getParent();
            let a = this.getRenderTargets()[t - 1], h = (f = this.curtain) == null ? void 0 : f.planes.find(p = > p.type === "PingPongPlane" && p.userData.id === e.local.id), o = e.compiledFragmentShaders[s.passIndex ? ? 0], l = r.effects.filter(p = > {
                if (this.layers.find(m = > m.parentLayer === p)) return this.layers.find(m = > m.parentLayer === p)
            }), d = l.indexOf(e.parentLayer), u = l[l.length - 1] === l[d], c = s.passIndex === s.length;
        ...
        createTextures() {
            const e = this.getPlanes().sort((s, i) = > s.renderOrder - i.renderOrder), t = e.length;
            for (let s = 0; s < t; s++) {
                const i = e[s];
        ...
        assignRenderTargetToPlane(e, t, s, i) {
            let r = this.getTextureParams(e, t, s), a = this.getRenderTargets()[t] || new Me(this.curtain, r);
        ...
        calculateItemMouseValues(e) {
            ...
            const t = this.bbox.width / 2, s = this.bbox.height / 2, i = this.getMousePosWithMomentum(e, t, s);
        ...
        getMousePosWithMomentum(e, t, s) {
            let i = this.mouse.pos.x, r = this.mouse.pos.y;
            ...
            const h = e.local.lastMousePos.x * t, o = (1 - e.local.lastMousePos.y) * s, l = Math.abs(i - h), d = Math.abs(r - o), u = .001;
    ...
    function Kt(n, e, t, s, i) {
        ...
        if (t) {
            ...
            if (a) try {
                ...
                return h != null && h.options && (h != null && h.history) ? Promise.resolve(h) : (s(new Error(`Did not find valid JSON inside $ {
                    t
                }`)), Promise.reject())
            } catch (h) {
                return s(new Error(`Error parsing JSON from $ {
                    t
                }: $ {
                    h.message
                }`)), Promise.reject()
            ...
            i || e != null && e.includes("production=true") ? (a = "https://assets.unicorn.studio", e = `v = $ {
                Date.now()
            }`) : e != null && e.includes("update=") || (e = `v = $ {
                Date.now()
            }`), r = `$ {
                a
            }
        ...
        return fetch(r).then(a = > a.json()).then(a = > a).
    ...
    function Je(n) {
        ...
        return new Promise((s, i) = > {
            Kt(e, t, n.filePath, i, n.production).then(r = > {
                (!r || !r.history || !r.options) && i(new Error(`Error fetching data
                    for project id '${n.projectId}'`));
                const a = r.options || {}, h = qt(n.element) ? n.element : document.getElementById(n.elementId);
                if (!h) {
                    i(new Error(``Couldn 't find an element with id ``
                                        $ {
                                            n.elementId
                                        }
                                        '
                ...
                let l = n.scale || a.scale || 1, d = n.dpi || a.dpi || Math.min(1.5, window.devicePixelRatio);
                const u = It(r.history, o, Zt(h, l, d)), c = new $t({
                    id: o,
                    fps: n.fps || a.fps || 60,
                    dpi: d,
                    name: a.name,
    ...
    function ts() {
        return es() ? new Promise((n, e) = > {
            ...
            t.filter(s = > !s.getAttribute("data-us-initialized")).forEach((s, i) = > {
                const r = j(s, "data-us-project"), a = j(s, "data-us-project-src"), h = j(s, "data-us-dpi"), o = j(s, "data-us-scale"), l = j(s, "data-us-lazyload"), d = j(s, "data-us-production"), u = j(s, "data-us-fps"), c = j(s, "data-us-alttext"), f = j(s, "data-us-arialabel"), p = j(s, "data-us-disablemobile"), m = j(s, "data-us-disablemouse"), v = j(s, "data-us-fixed");
